...
import { Sparkles, Check, Play, Info, Star, X } from 'lucide-react';
...
export const CinematicCanvas: React.FC<CinematicCanvasProps> = ({
  ...
  const processingSteps = [
    { id: 0, label: 'Understanding Intent' },
    { id: 1, label: 'Searching Semantic Space' },
    { id: 2, label: 'Ranking Recommendations' },
    { id: 3, label: 'Fetching Metadata' },
              ...
              <div className="flex-grow flex flex-col items-center sm:items-start gap-3.5 text-center sm:text-left">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-white text-black text-[11px] font-bold uppercase tracking-wider rounded-full hover:bg-rose-500 hover:text-white transition-all cursor-pointer shadow-lg"
                  >
                    <Play className="w-3 h-3 fill-current" />
                    Watch Trailer
                  </button>
                  <button className="inline-flex items-center gap-1.5 px-4 py-2 border border-white/10 hover:border-white/20 bg-white/[0.03] text-white text-[11px] font-bold uppercase tracking-wider rounded-full hover:bg-white/[0.06] transition-all cursor-pointer">
                ...
                {recommendations.map((movie, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2.5 p-2 rounded-xl border transition-all cursor-pointer text-left shrink-0 max-w-[200px] ${
                        isActive
