...
const steps: Step[] = [
  {
    ...
    sub: 'YOUR CINEMATIC TASTE PROFILE',
    body: 'Start by exploring a curated collection of films and shows. Every title you save helps ChitraAI understand the stories, genres, and emotions that resonate with you.',
    posters: [poster1, poster2, poster3],
    tag: 'Taste Mapping',
  },
  {
    num: '02',
    label: 'Learn your preferences',
    heading: 'Every choice\ntells a story',
    sub: 'UNDERSTANDING YOUR PREFERENCES',
    body: 'ChitraAI looks beyond genres to understand your preferences—from pacing and atmosphere to character-driven storytelling and emotional tone—creating a unique taste profile that evolves with every interaction.',
  ...
  },
  {
    ...
    heading: 'Describe what\nyou want',
    sub: 'INTELLIGENT DISCOVERY',
    body: 'Search naturally using moods, languages, genres, plots, or even a vague feeling. ChitraAI understands what you mean and finds movies that match your intent.',
    posters: [poster1, poster3, poster5],
    tag: 'Intent Understanding',
  },
  {
    num: '04',
    label: 'Find the best matches',
    heading: 'The best matches\nrise first',
    sub: 'PERSONALISED MATCHING',
    body: 'Thousands of potential titles are evaluated against your unique preferences and ranked by personal relevance, ensuring the most meaningful recommendations appear first.',
    posters: [poster2, poster4, poster6],
    tag: 'Smart Ranking',
  },

  {
    ...
    sub: 'ADAPTIVE RECOMMENDATIONS',
    body: 'Your recommendations continuously adapt to your evolving taste, blending favourites, hidden gems, timeless classics, and fresh discoveries into one personalised collection.',
    posters: [poster1, poster4, poster2],
...

  {
    ...
    body: 'Every rating, favourite, and interaction teaches ChitraAI more about your preferences, making every future recommendation smarter, more accurate, and uniquely yours.',
    posters: [poster3, poster5, poster6],
